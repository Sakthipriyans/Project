...
export const useAuthStore = defineStore('auth', {
  ...
  actions:{
    ...
    async login({ username, password }) {
      try {
        const response = await fetch('https://ticketshow-7tg7.onrender.com/login', {
          method: 'POST',
          headers: {
    ...
    async signup({ username, password, email }) {
      try {
        const response = await fetch('https://ticketshow-7tg7.onrender.com/signup', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    async addAdmin(username){
      try {
        const response = await fetch('https://ticketshow-7tg7.onrender.com/add_admin', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
    ...
    async fetchTheaters() {
      try {
        const response = await fetch('https://ticketshow-7tg7.onrender.com/theater', {
          // headers: {
          //   Authorization: `Bearer ${localStorage.getItem('authToken')}`,
          // },
        });
    ...
    async fetchTheaterById(theaterId) {
      try {
        const response = await fetch(`https://ticketshow-7tg7.onrender.com/theater/${theaterId}`, {
          // headers: {
          //   Authorization: `Bearer ${localStorage.getItem('authToken')}`,
          // },
        });
    ...
    async updateTheater(theaterId, theaterData) {
      try {
        const response = await fetch(`https://ticketshow-7tg7.onrender.com/${theaterId}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${localStorage.getItem('authToken')}`,
    ...
    async fetchShows() {
      try {
        const response = await fetch('https://ticketshow-7tg7.onrender.com/show', {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('authToken')}`,
          },
        });
    ...
    async fetchShowById(showId) {
      try {
        const response = await fetch(`https://ticketshow-7tg7.onrender.com/show/${showId}`, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('authToken')}`,
          },
        });
    ...
    async fetchBookings() {
      try {
        const response = await fetch('https://ticketshow-7tg7.onrender.com/booking', {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('authToken')}`,
          },
        });
    ...
    async vote(showId, voteData) {
      try {
        const response = await fetch(`https://ticketshow-7tg7.onrender.com/show/${showId}/vote`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${localStorage.getItem('authToken')}`,
    ...
    async comment(showId, commentData) {
      try {
        const response = await fetch(`https://ticketshow-7tg7.onrender.com/show/${showId}/comment`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${localStorage.getItem('authToken')}`,
    ...
    async export(theaterId){
      try{
        const response = await fetch(`https://ticketshow-7tg7.onrender.com/export_data/${theaterId}`);
        if (!response.ok) {
